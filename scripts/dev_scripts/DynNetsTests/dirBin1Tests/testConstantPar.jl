...
using JLD,Utilities,StaticNets,DynNets, Clustering
...
tmpPar,~ = gasFilter(modGasDirBin1,array2VecGasPar(modGasDirBin1,gasPar),groupsInds=groupsInds)
...
maxNgroups = 1
 ...
 gasParEstOnTrain = gasPar
    GasforeFit,~ = DynNets.gasFilter( DynNets.GasNetModelDirBin1(degsIO_T),
