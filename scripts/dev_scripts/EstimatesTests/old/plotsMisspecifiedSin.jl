...
tmpModelEst = DynNets.GasNetModelBin1_UmBAgr(zeros(10,10),[ones(GWest),ones(GBAest),ones(GBAest)],groupsIndsEst)
...
p =plot(p,titlefont = font(16),xlims = (0,T) ,titleloc=:center,
    title = "Gas DGP,N $(N) T = $(T) ",size=(1350,600))
