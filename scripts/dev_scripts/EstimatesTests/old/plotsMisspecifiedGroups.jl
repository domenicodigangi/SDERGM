...
tmpModelEst = DynNets.GasNetModelBin1(zeros(10,10),[ones(GWest),ones(GBAest),ones(GBAest)],groupsIndsEst)
tmpModelDgp = DynNets.GasNetModelBin1(zeros(10,10),[ones(GWdgp),ones(GBAdgp),ones(GBAdgp)],groupsIndsDgp)
