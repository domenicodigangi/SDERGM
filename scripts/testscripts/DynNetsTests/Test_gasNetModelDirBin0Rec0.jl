...
fig, ax = subplots(2,1)
for i=1:100
fVecT_dgp , A_T_dgp, sVecT_dgp = gasFilter( model_mle,  vResGasPar_0, indTvPar; dgpNT = (N,T))
...
fVecT_filt , target_fun_val_T, sVecT_filt = gasFilter( model_mle,  vResGasPar_0, indTvPar; obsT = stats_T_dgp)
fVecT_filt_p , target_fun_val_T_p, sVecT_filt_p = gasFilter( model_mple,  vResGasPar_0, indTvPar; obsT = change_stats_T_dgp)
...
fVecT_filt_p , target_fun_val_T_p, sVecT_filt_p = gasFilter( model_mple,  vResEstPar_mple, indTvPar; obsT = change_stats_T_dgp)
