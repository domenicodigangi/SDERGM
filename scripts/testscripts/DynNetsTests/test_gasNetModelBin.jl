...
GBA = 1
GW = 2#N#N#1# N#N # 20
groupsInds = [HelperFunDom.distributeAinVecN(Array{Int64}(1:GW),N), HelperFunDom.distributeAinVecN(Array{Int64}(1:GBA),GW)]
...
#     Fitness_T_filt, tmp = gasFilter( Mod, vresPar)
